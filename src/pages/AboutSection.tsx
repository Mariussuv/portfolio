  ...
  const hobbies = hobbyImages()
    ...
    return(
      <div className=" relative max-w-md w-full">
        ...
        <div className=" bg-secondary rounded-lg shadow-lg flex justify-between max-w-md p-4 bg-gradient-to-t from-secondary to-bg-white">
        ...
        <div className=" absolute w-full bottom-28">
          <MTypography type='title' text='things i also enjoy' variant='secondary'/>
